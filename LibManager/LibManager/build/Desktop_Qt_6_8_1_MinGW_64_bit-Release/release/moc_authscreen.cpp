...
namespace {
struct qt_meta_tag_ZN10AuthScreenE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10AuthScreenE = QtMocHelpers::stringData(
    "AuthScreen",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10AuthScreenE[] = {
...
Q_CONSTINIT const QMetaObject AuthScreen::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_ZN10AuthScreenE.offsetsAndSizes,
    qt_meta_data_ZN10AuthScreenE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10AuthScreenE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AuthScreen, std::true_type>,
...
{
    auto *_t = static_cast<AuthScreen *>(_o);
...
void *AuthScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10AuthScreenE.stringdata0))
